...
class LoginForm extends React.Component {
  ...
  vistaEstadistica = (e) =>{
    browserHistory.push('/vista/estadistica');
    e.preventDefault();
  } 
  ...
  render() {
    ...
    <div className="nav-wrapper azul">
      <ul id="nav-mobile" className="right hide-on-med-and-down">
        <li><a onClick={this.vistaEstadistica}>  <i className="small material-icons right">attach_money</i>Estadisticas DELATI</a></li>
